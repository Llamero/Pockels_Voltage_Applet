 ...
 * @author Ben
 */
public class calibrationWizardFrame extends javax.swing.JFrame {

    /**
     * Creates new form calibrationWizardFrame
     */
    public calibrationWizardFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TitleLabel.setText("Pockels Cell Voltage Calibration Wizard - Intro");
        ...
        getContentPane().add(step1Panel, "card3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calibrationWizardFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calibrationWizardFrame().setVisible(true);
            }
        });
    }
